...
# Loading model
with open(r"C:\Users\rohit\Python Project\Project 2\Classification.pkl", 'rb') as f:
...
def main():
    ...
    df = pd.read_csv(r'C:\Users\rohit\Downloads\DS Project\Project 2\Deployment\Input file format.csv')
    ...
    with open(r"C:\Users\rohit\Downloads\DS Project\Project 2\Deployment\Input file info.txt", 'r', encoding='utf-8') as file:
        content = file.read()
